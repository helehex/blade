...
def main() raises:
    ...
    iter = PopIter(0b01000000)
    assert_true(iter.__has_next__())
    assert_equal(iter.__next__(), 6)
    assert_false(iter.__has_next__())

    var riter = PopIter(0b0000).__reversed__()
    assert_false(riter.__has_next__())

    riter = PopIter(0b0001).__reversed__()
    assert_true(riter.__has_next__())
    assert_equal(riter.__next__(), 0)
    assert_false(riter.__has_next__())

    riter = PopIter(0b0010).__reversed__()
    assert_true(riter.__has_next__())
    assert_equal(riter.__next__(), 1)
    assert_false(riter.__has_next__())

    riter = PopIter(0b0011).__reversed__()
    assert_true(riter.__has_next__())
    assert_equal(riter.__next__(), 1)
    assert_true(riter.__has_next__())
    assert_equal(riter.__next__(), 0)
    ...
    riter = PopIter(0b01000000).__reversed__()
    assert_true(riter.__has_next__())
